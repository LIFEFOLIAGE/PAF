...
public class ResultSetSerializer extends StdSerializer<ResultSet>{
	...
	public static Pair<String[], int[]> intitSerializer(ResultSet rs) throws SQLException {
		ResultSetMetaData rsmd = rs.getMetaData();
		int numColumns = rsmd.getColumnCount();
		String[] columnNames = new String[numColumns];
		int[] columnTypes = new int[numColumns];
	...
	public static void serializeRow(ResultSet rs, String[] columnNames, int[] columnTypes, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException, SQLException {
	...
	public static ObjectNode ToObjectNode(ResultSet resultset) {
