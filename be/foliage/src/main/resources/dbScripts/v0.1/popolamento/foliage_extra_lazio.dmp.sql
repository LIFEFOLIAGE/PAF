...
--
-- Name: lazio_dem; Type: TABLE; Schema: foliage_extra; Owner: foliage
--

CREATE TABLE foliage_extra.lazio_dem (
    rid integer NOT NULL,
    rast public.raster,
    CONSTRAINT enforce_height_rast CHECK ((public.st_height(rast) = ANY (ARRAY[2700, 2020]))),
    ...
    CONSTRAINT enforce_same_alignment_rast CHECK (public.st_samealignment(rast, '01000000003B81D7C289682B3F3B81D7C289682BBFA13F17C272C22640179E3BA39D6E454000000000000000000000000000000000E610000001000100'::public.raster)),
    CONSTRAINT enforce_scalex_rast CHECK ((round((public.st_scalex(rast))::numeric, 10) = round(0.0002091091313749601, 10))),
    CONSTRAINT enforce_scaley_rast CHECK ((round((public.st_scaley(rast))::numeric, 10) = round((- 0.0002091091313749601), 10))),
    CONSTRAINT enforce_srid_rast CHECK ((public.st_srid(rast) = 4326)),
    CONSTRAINT enforce_width_rast CHECK ((public.st_width(rast) = ANY (ARRAY[2700, 2463])))
);


ALTER TABLE foliage_extra.lazio_dem OWNER TO foliage;

--
-- Name: lazio_dem_rid_seq; Type: SEQUENCE; Schema: foliage_extra; Owner: foliage
--

CREATE SEQUENCE foliage_extra.lazio_dem_rid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE foliage_extra.lazio_dem_rid_seq OWNER TO foliage;

--
-- Name: lazio_dem_rid_seq; Type: SEQUENCE OWNED BY; Schema: foliage_extra; Owner: foliage
--

ALTER SEQUENCE foliage_extra.lazio_dem_rid_seq OWNED BY foliage_extra.lazio_dem.rid;


--
-- Name: lazio_slope; Type: TABLE; Schema: foliage_extra; Owner: foliage
--

CREATE TABLE foliage_extra.lazio_slope (
    rid integer NOT NULL,
    rast public.raster,
    CONSTRAINT enforce_height_rast CHECK ((public.st_height(rast) = ANY (ARRAY[2700, 2455]))),
    CONSTRAINT enforce_nodata_values_rast CHECK ((public._raster_constraint_nodata_values(rast) = '{-9999.0000000000}'::numeric[])),
    CONSTRAINT enforce_num_bands_rast CHECK ((public.st_numbands(rast) = 1)),
    CONSTRAINT enforce_out_db_rast CHECK ((public._raster_constraint_out_db(rast) = '{f}'::boolean[])),
    CONSTRAINT enforce_pixel_types_rast CHECK ((public._raster_constraint_pixel_types(rast) = '{32BF}'::text[])),
    CONSTRAINT enforce_same_alignment_rast CHECK (public.st_samealignment(rast, '010000000077FFF4C9E89D2B3F77FFF4C9E89D2BBF00CF8F82758426404C886BA08B75454000000000000000000000000000000000E610000001000100'::public.raster)),
    CONSTRAINT enforce_scalex_rast CHECK ((round((public.st_scalex(rast))::numeric, 10) = round(0.00021069971715270325, 10))),
    CONSTRAINT enforce_scaley_rast CHECK ((round((public.st_scaley(rast))::numeric, 10) = round((- 0.00021069971715270325), 10))),
    CONSTRAINT enforce_srid_rast CHECK ((public.st_srid(rast) = 4326)),
    CONSTRAINT enforce_width_rast CHECK ((public.st_width(rast) = ANY (ARRAY[2700, 367])))
);


ALTER TABLE foliage_extra.lazio_slope OWNER TO foliage;

--
-- Name: lazio_slope_rid_seq; Type: SEQUENCE; Schema: foliage_extra; Owner: foliage
--

CREATE SEQUENCE foliage_extra.lazio_slope_rid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE foliage_extra.lazio_slope_rid_seq OWNER TO foliage;

--
-- Name: lazio_slope_rid_seq; Type: SEQUENCE OWNED BY; Schema: foliage_extra; Owner: foliage
--

ALTER SEQUENCE foliage_extra.lazio_slope_rid_seq OWNED BY foliage_extra.lazio_slope.rid;
...
--
-- Name: lazio_dem rid; Type: DEFAULT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE ONLY foliage_extra.lazio_dem ALTER COLUMN rid SET DEFAULT nextval('foliage_extra.lazio_dem_rid_seq'::regclass);


--
-- Name: lazio_slope rid; Type: DEFAULT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE ONLY foliage_extra.lazio_slope ALTER COLUMN rid SET DEFAULT nextval('foliage_extra.lazio_slope_rid_seq'::regclass);
...
--
-- Name: lazio_dem enforce_max_extent_rast; Type: CHECK CONSTRAINT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE foliage_extra.lazio_dem
    ADD CONSTRAINT enforce_max_extent_rast CHECK ((public.st_envelope(rast) OPERATOR(public.@) '0103000020E61000000100000005000000A13F17C272C226404C08C481BE5F4440A13F17C272C22640179E3BA39D6E4540A1BA4CBB6F4E2C40179E3BA39D6E4540A1BA4CBB6F4E2C404C08C481BE5F4440A13F17C272C226404C08C481BE5F4440'::public.geometry)) NOT VALID;


--
-- Name: lazio_slope enforce_max_extent_rast; Type: CHECK CONSTRAINT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE foliage_extra.lazio_slope
    ADD CONSTRAINT enforce_max_extent_rast CHECK ((public.st_envelope(rast) OPERATOR(public.@) '0103000020E6100000010000000500000000CF8F827584264034D62BB5E158444000CF8F82758426404C886BA08B7545400A694323685C2C404C886BA08B7545400A694323685C2C4034D62BB5E158444000CF8F827584264034D62BB5E1584440'::public.geometry)) NOT VALID;
...
--
-- Name: lazio_dem lazio_dem_pkey; Type: CONSTRAINT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE ONLY foliage_extra.lazio_dem
    ADD CONSTRAINT lazio_dem_pkey PRIMARY KEY (rid);


--
-- Name: lazio_slope lazio_slope_pkey; Type: CONSTRAINT; Schema: foliage_extra; Owner: foliage
--

ALTER TABLE ONLY foliage_extra.lazio_slope
    ADD CONSTRAINT lazio_slope_pkey PRIMARY KEY (rid);
...
--
-- Name: lazio_dem_st_convexhull_idx; Type: INDEX; Schema: foliage_extra; Owner: foliage
--

CREATE INDEX lazio_dem_st_convexhull_idx ON foliage_extra.lazio_dem USING gist (public.st_convexhull(rast));


--
-- Name: lazio_slope_st_convexhull_idx; Type: INDEX; Schema: foliage_extra; Owner: foliage
--

CREATE INDEX lazio_slope_st_convexhull_idx ON foliage_extra.lazio_slope USING gist (public.st_convexhull(rast));
